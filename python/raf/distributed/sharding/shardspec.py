...
@register_node("raf.sharding.BaseSpec")
class BaseSpec(Value):
    """Base type of Sharding Specifications"""


@register_node("raf.sharding.MirroredSpec")
class MirroredSpec(BaseSpec):
    """Annotation denoting every rank has a full copy of this tensor"""

    def __init__(self, immutable=False):
        self.__init_handle_by_constructor__(_make.MirroredSpec, immutable)


@register_node("raf.sharding.TupleSpec")
class TupleSpec(BaseSpec):
    ...
    def __init__(self, tuple_elem, immutable=False):
        ...
        self.__init_handle_by_constructor__(_make.TupleSpec, immutable, tuple_elem)
